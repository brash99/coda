...
proc RunSample {w} {
    ...
    set style(header) [tixDisplayStyle text -fg black -anchor c -padx 8 -pady 2\
    ...
    set style(mgr_name)  [tixDisplayStyle text -fg #202060 \
	-selectforeground  #202060 \
	-font [tix option get bold_font ]]
    set style(mgr_posn)  [tixDisplayStyle text -fg #202060 -padx 8 \
	-selectforeground  #202060]

    set style(empl_name) [tixDisplayStyle text -fg #602020 \
	-selectforeground  #602020  \
	-font [tix option get bold_font ]]
    set style(empl_posn) [tixDisplayStyle text -fg #602020 -padx 8 \
	-selectforeground  #602020 ]
