...
proc tixScrolledWidget::SetBindings {w} {
	...
	"tixScrolledWidget::ClientGeomProc $w {} $data(w:hsb)"

    tixManageGeometry $data(w:vsb) "tixScrolledWidget::ClientGeomProc $w"
    bind $data(w:vsb) <Configure> \
	"tixScrolledWidget::ClientGeomProc $w {} $data(w:vsb)"
...
#	    tixUnmapWindow $data(w:pann)
	...
	"01" {
	    ...
	    tixMoveResizeWindow $data(w:vsb) $scbx 0 $scbW $mh
...
#	    tixUnmapWindow $data(w:pann)
	...
	"10" {
	    ...
	    tixMoveResizeWindow $data(w:hsb) 0 $scby $mw $scbH 
...
#	    tixUnmapWindow $data(w:pann)
	...
	"11" {
	    ...
	    tixMoveResizeWindow $data(w:hsb) 0 $scby $cw $scbH
	    tixMoveResizeWindow $data(w:vsb) $scbx 0 $scbW $ch
#	    tixMoveResizeWindow $data(w:pann) \
#		[expr $scbx+2] [expr $scby+2] \
#		[expr $scbW-4] [expr $scbH-4]
