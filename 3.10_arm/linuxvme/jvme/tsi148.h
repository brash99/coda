/*
 * tsi148.h
 *   - Header file containing memory map and
 *     useful bit definition and masks for the tsi148
 *
 */
...
#define TSI148_MAX_SEMAPHORES         8        /* Max Semaphores */
     ...
     */
    typedef struct {
        volatile unsigned int	otsau;	/* Starting address */
        volatile unsigned int	otsal;
        volatile unsigned int	oteau;	/* Ending address */
        volatile unsigned int	oteal;
        volatile unsigned int	otofu;	/* Translation offset */
        volatile unsigned int	otofl;
        volatile unsigned int	otbs;	/* 2eSST broadcast select */
        volatile unsigned int	otat;	/* Attributes */
     ...
     */
    typedef struct {
        volatile unsigned int	itsau;	/* Starting address */
        volatile unsigned int	itsal;
        volatile unsigned int	iteau;	/* Ending address */
        volatile unsigned int	iteal;
        volatile unsigned int	itofu;	/* Translation offset */
        volatile unsigned int	itofl;
        volatile unsigned int	itat;	/* Attributes */
     ...
     */
    typedef struct {
        volatile unsigned int	dctl;	/* Control */
        volatile unsigned int	dsta;	/* Status */
        volatile unsigned int	dcsau;	/* RO Current Source address */
        volatile unsigned int	dcsal;
        volatile unsigned int	dcdau;	/* RO Current Destination address */
        volatile unsigned int	dcdal;
        volatile unsigned int	dclau;	/* RO Current Link address */
        volatile unsigned int	dclal;
        volatile unsigned int	dsau;	/* Source Address */
        volatile unsigned int	dsal;
        volatile unsigned int	ddau;	/* Destination Address */
        volatile unsigned int	ddal;
        volatile unsigned int	dsat;	/* Source attributes */
        volatile unsigned int	ddat;	/* Destination attributes */
        volatile unsigned int	dnlau;	/* Next link address */
        volatile unsigned int	dnlal;
        volatile unsigned int	dcnt;	/* Byte count */
        volatile unsigned int	ddbs;	/* 2eSST Broadcast select */
     ...
     */
    typedef struct {
        volatile unsigned short	veni;		/* PCI header VENI/DEVI */
        volatile unsigned short	devi;
        volatile unsigned short	cmmd;		/* PCI header CMMD/STAT */
        volatile unsigned short	stat;
        volatile unsigned int	reviAndClas;	/* PCI header REVI/CLAS */
        volatile unsigned char	clsz;		/* PCI header CLSZ/MLAT/HEAD/reserved */
        volatile unsigned char	mlat;
        volatile unsigned char	head;
        unsigned char	reserved0[1];
        volatile unsigned int	mbarl;		/* PCI header MBARL */
        volatile unsigned int	mbaru;		/* PCI header MBARU */
        unsigned char	reserved1[20];
        volatile unsigned short	subv;		/* PCI header SUBV/SUBI */
        volatile unsigned short	subi;
        unsigned char	reserved2[4];	/* PCI header reserved */
        volatile unsigned char	capp;		/* PCI header CAPP/reserved */
        unsigned char	reserved3[7];	/* PCI header reserved */
        volatile unsigned char	intl;		/* PCI header INTL/INTP/MNGM/MXLA */
        volatile unsigned char	intp;
        volatile unsigned char	mngn;
        volatile unsigned char	mxla;
         ...
         */
        volatile unsigned char	msiCapID;
        volatile unsigned char	msiNextCapPtr;
        volatile unsigned short	msiControl;
        volatile unsigned int	msiMsgAddrL;
        volatile unsigned int	msiMsgAddrU;
        volatile unsigned short	msiMsgData;
         ...
         */
        volatile unsigned char	pcixCapID;
        volatile unsigned char	pcixNextCapPtr;
        volatile unsigned short	pcixCommand;
        volatile unsigned int	pcixStatus;
    ...
    typedef struct {
         ...
         */
        volatile unsigned char	viack[8*4];

        /*
         * RMW
         * offset    220
         */
        volatile unsigned int	rmwau;
        volatile unsigned int	rmwal;
        volatile unsigned int	rmwen;
        volatile unsigned int	rmwc;
        volatile unsigned int	rmws;

        /*
         * VMEbus control
         * offset    234
         */
        volatile unsigned int	vmctrl;
        volatile unsigned int	vctrl;
        volatile unsigned int	vstat;

        /*
         * PCI status
         * offset  240
         */
        volatile unsigned int	pstat;
        volatile unsigned char	pstatrsvd[0xc];

        /*
         * VME filter.
         * offset  250
         */
        volatile unsigned int	vmefl;
        volatile unsigned char	vmeflrsvd[0xc];

        /*
         * VME exception.
         * offset  260
         */
        volatile unsigned int	veau;
        volatile unsigned int	veal;
        volatile unsigned int	veat;
        volatile unsigned char	vearsvd[0x4];

        /*
         * PCI error
         * offset  270
         */
        volatile unsigned int	edpau;
        volatile unsigned int	edpal;
        volatile unsigned int	edpxa;
        volatile unsigned int	edpxs;
        volatile unsigned int	edpat;
        volatile unsigned char	edparsvd[0x7c];
         ...
         * offset  400
         */
        volatile unsigned int	gbau;
        volatile unsigned int	gbal;
        volatile unsigned int	gcsrat;

        /*
         * Inbound Translation CRG
         * offset  40C
         */
        volatile unsigned int	cbau;
        volatile unsigned int	cbal;
        volatile unsigned int	csrat;
         ...
         * offset  418
         */
        volatile unsigned int	crou;
        volatile unsigned int	crol;
        volatile unsigned int	crat;

        /*
         * Inbound Translation Location Monitor
         * offset  424
         */
        volatile unsigned int	lmbau;
        volatile unsigned int	lmbal;
        volatile unsigned int	lmat;

        /*
         * VMEbus Interrupt Control.
         * offset  430
         */
        volatile unsigned int	bcu;
        volatile unsigned int	bcl;
        volatile unsigned int	bpgtr;
        volatile unsigned int	bpctr;
        volatile unsigned int	vicr;

        volatile unsigned char	vicrsvd[0x4];
        ...
        volatile unsigned int	inteo;
        volatile unsigned int	ints;
        volatile unsigned int	intc;
        volatile unsigned int	intm1;
        volatile unsigned int	intm2;
    ...
    typedef struct {
         ...
         */
        unsigned volatile short	devi;
        unsigned volatile short	veni;
         ...
         */
        unsigned volatile short	ctrl;
        unsigned volatile char	ga;
        unsigned volatile char	revid;
         ...
         */
        unsigned volatile char	semaphore[TSI148_MAX_SEMAPHORES];
         ...
         */
        unsigned volatile int	mbox[TSI148_MAX_MAILBOXES];
    ...
    typedef struct {
         ...
         */
        unsigned volatile int	csrbcr;
        unsigned volatile int	csrbsr;
        unsigned volatile int	cbar;
    } tsi148Crcsr_t;
    ...
    typedef struct {
         ...
         * PCFS
         */
        volatile tsi148Pcfs_t pcfs;

        /*
         * LCSR
         */
        volatile tsi148Lcsr_t lcsr;

        /*
         * GCSR
         */
        volatile tsi148Gcsr_t gcsr;
