...
#define FA_SUPPORTED_CTRL_FIRMWARE 0x52
#define FA_SUPPORTED_CTRL_FIRMWARE_NUMBER 1
#define FA_SUPPORTED_PROC_FIRMWARE 0xC12
#define FA_SUPPORTED_PROC_FIRMWARE_NUMBER 1

struct FA250_STATE_REGS
{
  /* 0x0000 */ volatile unsigned int level;
  /* 0x0004 */ volatile unsigned int csr;
  /* 0x0008 */ volatile unsigned int value;
  /* 0x000C */          unsigned int spare;
  /* 0x0010 */ volatile unsigned int berr_drive_count;
  /* 0x0014 */ volatile unsigned int retry_drive_count;
};
...
struct fadc_struct
{
  ...
  /* 0x0200 */ volatile unsigned int status4;
  /* 0x01A0 */          unsigned int spare_adc[(0x204-0x1A0)>>2];
  ...
  /* 0x0414 */          unsigned int blank[(0x500-0x414)>>2];

  /* 0x0500 */ struct FA250_STATE_REGS state;
};
...
int  faDebugOutput(int id, volatile unsigned int *data, int nwords);
int  faGetDebugRegs(int id, volatile unsigned int *data, int nwords);
int  faPrintDebugOutput();
