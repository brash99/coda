...
#define SD_SUPPORTED_FIRMWARE  0xA9

/* JLab SD Register definitions (defined within TI/TS register space) */
struct SDStruct
{
  /** @brief 0x0000 */          unsigned int blankSD0[(0x3C00-0x0000)/4]; /**< Not used */
  /** @brief 0x3C00 */ volatile unsigned int system;  /**< Device 1,  Address 0x0 */
  /** @brief 0x3C04 */ volatile unsigned int status;             /**< Address 0x1 */
  /** @brief 0x3C08 */ volatile unsigned int payloadPorts;       /**< Address 0x2 */
  /** @brief 0x3C0C */ volatile unsigned int tokenPorts;         /**< Address 0x3 */
  /** @brief 0x3C10 */ volatile unsigned int busyoutPorts;       /**< Address 0x4 */
  /** @brief 0x3C14 */ volatile unsigned int trigoutPorts;       /**< Address 0x5 */
  /** @brief 0x3C1C */ volatile unsigned int busyoutStatus;      /**< Address 0x7 */
  /** @brief 0x3C20 */ volatile unsigned int trigoutStatus;      /**< Address 0x8 */
  /** @brief 0x3C18 */          unsigned int RFU0;               /**< Address 0x6 */
  /** @brief 0x3C24 */ volatile unsigned int busyoutCounter[16]; /**< Address 0x9-0x18 */
  /** @brief 0x3C64 */ volatile unsigned int busyoutTest;        /**< Address 0x19 */
  /** @brief 0x3C68 */ volatile unsigned int sdLinkTest;         /**< Address 0x1A */
  /** @brief 0x3C6C */ volatile unsigned int tokenInTest;        /**< Address 0x1B */
  /** @brief 0x3C70 */ volatile unsigned int trigOutTest;        /**< Address 0x1C */
  /** @brief 0x3C74 */ volatile unsigned int tokenOutTest;       /**< Address 0x1D */
  /** @brief 0x3C78 */ volatile unsigned int statBitBTest;       /**< Address 0x1E */
  /** @brief 0x3C7C */ volatile unsigned int version;            /**< Address 0x1F */
  /** @brief 0x3C80 */ volatile unsigned int csrTest;            /**< Address 0x20 */
  /** @brief 0x3C84 */ volatile unsigned int trigoutCounter[16]; /**< Address 0x21-0x30 */
  /** @brief 0x3CC4 */ volatile unsigned int clkACounterTest;    /**< Address 0x31 */
  /** @brief 0x3CC8 */ volatile unsigned int clkBCounterTest;    /**< Address 0x32 */
  /** @brief 0x3CCC */          unsigned int blankSD1[(0x3D14-0x3CCC)/4]; /**< Not used */
  /** @brief 0x3D14 */ volatile unsigned int memAddrLSB;         /**< Address 0x45 */
  /** @brief 0x3D18 */ volatile unsigned int memAddrMSB;         /**< Address 0x46 */
  /** @brief 0x3D1C */ volatile unsigned int memWriteCtrl;       /**< Address 0x47 */
  /** @brief 0x3D20 */ volatile unsigned int memReadCtrl;        /**< Address 0x48 */
  /** @brief 0x3D24 */ volatile unsigned int memCheckStatus;     /**< Address 0x49 */
  /** @brief 0x3D28 */          unsigned int blankSD2[(0x10000-0x3D28)/4]; /**< Not used */
};
...
int  sdSetBusyVmeSlots(unsigned int vmemask, int reset);
