...
#define VFTDC_SUPPORTED_FIRMWARE 0x72
...
#define VFTDC_PL_RISING_EDGE_DISABLE   (1<<14)
#define VFTDC_PL_FALLING_EDGE_DISABLE  (1<<15)
#define VFTDC_PL_EDGE_DISABLE_MASK  0x0000C000
...
int  vfTDCSetEdgeReadout(int id, int rise, int fall);
int  vfTDCGetEdgeReadout(int id, int *rise, int *fall);
